            ...
            <li class="nav-item {{ active('categories-list') . active('categories-add') . active('categories-edit') . active('sub-categories-list') . active('sub-categories-add') . active('sub-categories-edit') . active('products-list') . active('products-add') . active('products-edit') }}">
              ...
              <div class="multi-level collapse " role="list" id="submenu-pages" aria-expanded="false">
                <ul class="flex-column nav">
                  ...
                  <li class="nav-item {{ active('products-list') . active('products-add') . active('products-edit') }}"><a class="nav-link" href="{{route('admin_products')}}"><i class="fas fa-box-open"></i><span> Auto Parts</span></a></li>
                  <li class="nav-item {{ active('products-car-list') . active('products-car-add') . active('products-car-edit') }}"><a class="nav-link" href="{{route('admin_products_cars')}}"><i class="fas fa-box-open"></i><span> Cars </span></a></li>
                </ul>
              </div>
            </li>
                  ...
                  <a class="nav-link pt-1 px-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media d-flex align-items-center">
                      ...
                      <div class="media-body ml-2 text-dark align-items-center d-none d-lg-block">
                        <span class="mb-0 font-small font-weight-bold"><i class="fas fa-caret-down"></i>{{auth()->user()->username}}</span>
                      </div>
                    </div>
                  </a>
