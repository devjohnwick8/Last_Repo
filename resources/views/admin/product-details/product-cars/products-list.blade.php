    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Products-List (Cars)</h1>
            </div>
            <div>
                <a href="{{route('admin_products_cars_add')}}" class="btn btn-outline-gray"><i class="far fa-plus-square mr-1"></i> Add New Product</a>
            </div>
        </div>
    </div>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                    ...
                    @foreach($products as $key=>$value)
                        <tr>
                            ...
                            <td class="border-0">
                                <a href="{{route('admin_products_cars_edit').'/'.$value->id}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                                <span class="text-primary"> |  </span>
                                <a href="{{route('admin_products_cars_delete').'/'.$value->id}}" class="text-danger ml-3"><i class="far fa-trash-alt"></i>Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    <!-- End of Item -->
